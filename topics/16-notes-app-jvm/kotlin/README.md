# 16. 간단한 Kotlin/JVM 메모 앱 / kotlin

## 어디에 작성하나

- 핵심 로직/앱: `src/main/kotlin/dev/reinvent/wheel/t16/NotesAppJvmApp.kt`
- 기본 테스트: `src/test/kotlin/dev/reinvent/wheel/t16/NotesAppJvmAppTest.kt`
