...
- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t05/ThreadPoolQueueApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t05/ThreadPoolQueueAppTest.java`
