...
make -s --no-print-directory run > /tmp/tiny-async-executor-rust-out.txt
if ! diff -u "$ROOT/fixtures/mission-expected.txt" /tmp/tiny-async-executor-rust-out.txt; then
