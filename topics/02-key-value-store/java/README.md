# 02. 인메모리 `key-value store` / java

## 어디에 작성하나

- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t02/KeyValueStoreApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t02/KeyValueStoreAppTest.java`
