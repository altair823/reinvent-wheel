# 02. 인메모리 `key-value store` / kotlin

## 어디에 작성하나

- 핵심 로직/앱: `src/main/kotlin/dev/reinvent/wheel/t02/KeyValueStoreApp.kt`
- 기본 테스트: `src/test/kotlin/dev/reinvent/wheel/t02/KeyValueStoreAppTest.kt`
