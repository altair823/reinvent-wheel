# 03. HTTP 서버와 라우터 직접 만들기 / java

## 어디에 작성하나

- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t03/HttpServerRouterApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t03/HttpServerRouterAppTest.java`
