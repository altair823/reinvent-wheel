# 14. rate limiter / java

## 어디에 작성하나

- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t14/RateLimiterApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t14/RateLimiterAppTest.java`
