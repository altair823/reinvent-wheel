# 17. DSL 스타일 설정 파서 / kotlin

## 어디에 작성하나

- 핵심 로직/앱: `src/main/kotlin/dev/reinvent/wheel/t17/DslConfigParserApp.kt`
- 기본 테스트: `src/test/kotlin/dev/reinvent/wheel/t17/DslConfigParserAppTest.kt`
