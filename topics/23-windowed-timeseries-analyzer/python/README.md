# 23. windowed timeseries analyzer / python

## 어디에 작성하나

- 핵심 로직: `src/t23_windowed_timeseries_analyzer_python/core.py`
- CLI 진입점: `src/t23_windowed_timeseries_analyzer_python/cli.py`
