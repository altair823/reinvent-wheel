# 12. 작은 dependency injection container / java

## 어디에 작성하나

- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t12/DiContainerApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t12/DiContainerAppTest.java`
