# 13. 간단한 JDBC-backed todo app / java

## 어디에 작성하나

- 핵심 로직/앱: `src/main/java/dev/reinvent/wheel/t13/JdbcTodoCliApp.java`
- 기본 테스트: `src/test/java/dev/reinvent/wheel/t13/JdbcTodoCliAppTest.java`
